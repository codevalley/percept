          ...
          <div class="relative flex items-center mb-6">
            ...
            <div class="relative w-full">
              <input v-model="newQuestion.text" @keyup.enter="handleAddOrSuggest" @input="handleQuestionChange"
                ...
                class="w-full bg-transparent text-[28px] font-regular text-primary focus:outline-none pr-10 transition-all duration-300 ease-in-out transform hover:scale-102 focus:scale-102"
            ...
            <div class="flex items-center space-x-2">
              <transition name="fade-scale" mode="out-in">
                <button v-if="newQuestion.text.trim() && !newQuestion.isAutogenerated" 
                        ...
                        class="w-10 h-10 rounded-full flex items-center justify-center bg-accent" 
                        :disabled="isSubmitted"
            ...
            <div v-for="(question, index) in questions" :key="question.id" class="flex items-center justify-between">
              <div class="flex items-center space-x-4">
                <div class="flex items-center space-x-2">
                  ...
                  <button @click="editQuestion(index)" class="text-accent hover:text-accent-dark">
