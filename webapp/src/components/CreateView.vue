    ...
    <div class="max-w-[859px] mx-auto px-4 sm:px-6 pb-24 sm:pb-0">
      ...
      <div class="flex flex-col sm:flex-row items-center sm:items-start mb-4 sm:mb-6">
        ...
        <div class="flex-grow text-center sm:text-left">
          <input
            v-model="surveyTitle"
            class="text-neutral-600 text-xl sm:text-2xl font-semibold leading-8 sm:leading-10 mb-2 sm:mb-1 w-full bg-transparent focus:outline-none"
            :placeholder="t('createView.titlePlaceholder')"
          />
          <textarea
            v-model="surveyDescription"
            class="text-neutral-600 text-base sm:text-lg font-normal leading-6 sm:leading-7 w-full bg-transparent focus:outline-none resize-none"
            :placeholder="t('createView.descriptionPlaceholder')"
            rows="2"
          ></textarea>
        </div>
      </div>
